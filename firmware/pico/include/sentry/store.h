...
// magic, version, reserved, length, sequence, checksum.
...
// Frame one record. Returns the bytes written, or 0 if it does not fit or is too large.
...
// disagree — which is every way an interrupted write can look from here.
